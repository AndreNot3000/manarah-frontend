...
export default function StudentDashboard() {
  return (
    <section>
      <h2 className="text-[1.75rem] text-center sm:text-left">Assalamu Alaikum, Omar</h2>
      <p className="text-center my-1 sm:text-left">Your journey of illumination continues today.</p>
      <div className="md:grid grid-cols-12 gap-4">
        {/* Active Competition */}
        <Card className="my-6 col-span-8 sm:max-w-">
        ...
        {/* Certificates */}
        <Card className="my-4 sm:col-span-4">
      ...
      {/* Mentors */}
      <Card>
        <CardHeader className="flex flex-row items-center justify-between text-sm font-semibold sm:text-2xl">
        ...
        <div className="flex justify-between gap-3 sm:justify-start sm:gap-8 mt-5 mb-3">
      ...
      <div className="sm:grid grid-cols-12 gap-6 my-6">
        {/* Goal */}
        <Card className="my-4 col-span-6 sm:my-0">
        ...
        <Card className="col-span-6">
          ...
          <div className="sm:flex gap- ">
            {/* <div className="hidden sm:block">
              <Image src="/assets/Images/book.png" alt="" width={120} height={200} />
            </div> */}
            <ul className="my-3">
              <li className="flex items-center gap-2 my-4 sm:my-0 sm:mb-4">
              ...
              <li className="flex items-center gap-2 my-4 sm:my-0">
