      ...
      <div className="flex-1 flex flex-col min-h-screen min-w-0 overflow-x-hidden">
        ...
        <header className="sticky top-0 z-30 bg-white border-b border-slate-200 h-16 flex items-center justify-between px-6 md:px-8">
          ...
          <div className="hidden md:block">
            <span className="text-slate-500 font-semibold text-sm">Student Dashboard</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-8 w-8 rounded-full bg-slate-200 flex items-center justify-center font-bold text-primary border-2 border-primary-light">
              {name.charAt(0).toUpperCase()}
            </div>
            <Button
              onClick={handleLogout}
